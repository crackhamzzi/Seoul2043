...
import { Metadata, ResolvedViewport } from "../shims/metadata.js";
...
declare function resolveHttpAccessFallbackViewport<TModule extends AppPageHeadModule>(options: HttpAccessFallbackMetadataPlanOptions<TModule>): Promise<ResolvedViewport>;
//#endregion
