...
async function streamPageToResponse(res, element, options) {
	const { url, server, fontHeadHTML, assetHeadHTML = "", scripts, DocumentComponent, statusCode, extraHeaders, getHeadHTML, enhancePageElement, scriptNonce, documentContext, setDocumentInitialHead, crossOrigin, bufferBodyBeforeHeaders = false } = options;
	...
	return async (req, res, url, statusCode, isDataReq = false, originalUrl = url) => {
		...
		return runWithRequestContext(requestContext, async () => {
			...
			try {
				...
				const assetHeadHTML = await collectDevInitialStylesheetHeadHTML(server, runner, [appAssetPath, route.filePath], nonceAttr);
				const allFontStyles = [];
